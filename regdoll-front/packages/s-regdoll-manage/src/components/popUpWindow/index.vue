 ...
 * @Editors: lgldlk
 * @LastEditTime: 2021-07-20 18:15:42
-->
<template>
      ...
      <div class="center-slot"
        ...
        <div class="slot-header">
          ...
          <svg t="1622298296948"
            ...
            <path d="M77.550933 29.2864l917.162667 917.162667-48.264533 48.264533L29.2864 77.550933z"
                  fill="#2c2c2c"></path>
            <path d="M946.449067 29.2864L29.2864 946.449067l48.264533 48.264533 917.162667-917.162667z"
                  fill="#2c2c2c"></path>
          </svg>
        </div>
        <slot> </slot>
