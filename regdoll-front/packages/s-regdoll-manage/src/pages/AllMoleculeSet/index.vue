 ...
 * @Editors: lgldlk
 * @LastEditTime: 2021-07-16 16:44:02
-->
<template>
 <div class="crumbs">
    ...
    <div class="container">
      ...
      >
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="expression" label="分子表达式" ></el-table-column>
        <el-table-column prop="matterState" label="物态（常温）"></el-table-column>
        <el-table-column prop="meltingPoint" label="熔点" width="60"></el-table-column>

        <el-table-column prop="density" label="密度"></el-table-column
        ><el-table-column prop="reactivity" label="水溶性" width="60"></el-table-column
        >
        >
        <el-table-column prop="knowledgePoint" label="知识点">
          <template #default="scope">
            {{ scope.row.knowledgePoint.substr(0, 15) + "......" }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="140" align="center">
          <template #default="scope">
            <el-button
              type="text"
              icon="el-icon-edit"
              @click="moleculeEdit(scope.$index, scope.row)"
              >编辑</el-button
            >
            <el-button
              type="text"
              icon="el-icon-delete"
              class="text_red"
              @click="moleculeDelete(scope.$index, scope.row)"
              >删除</el-button
            >
          </template>
        </el-table-column>
       ...
       <el-drawer title="保存分子" v-model="saveToMoleculeVis" direction="rtl">
        <div class="moleculeCon drawer-inside">
          ...
          <el-input
            ...
            placeholder="请输入密度"
          ></el-input>
          <div v-for="item in valenceList" :key="item.id">
          ...
          <div class="">
            <el-button type="primary" plain @click="updateMolecule">保存</el-button>

            <el-button type="primary" plain @click="gotoEditTheMolecule">保存并编辑位置</el-button>
          </div>
        </div>
      </el-drawer>
</template>
